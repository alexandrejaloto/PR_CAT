...
png (
  filename = paste0 ('graphics/rmse.png'),
  width = 3200,
  height = 3200,
  units = "px",
  pointsize = 12,
...
png (
  filename = paste0 ('graphics/se.png'),
  width = 3200,
  height = 3200,
  units = "px",
  pointsize = 12,
...
png (
  filename = paste0 ('graphics/density_information.png'),
  width = 3200,
  height = 3200,
  units = "px",
  pointsize = 12,
...
graphic$precision <- ifelse(graphic$precision == 'Erro', 'Error', 'RMSE')
...
png (
  filename = paste0 ('graphics/linear.png'),
  width = 3200,
  height = 3200,
  units = "px",
  pointsize = 12,
